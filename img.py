...
poubelle_jaune = pygame.transform.smoothscale(poubelle_jaune, (65, 120))

poubelle_verte = pygame.image.load("Images/poubelle_verte.png").convert_alpha()
poubelle_verte = pygame.transform.smoothscale(poubelle_verte, (65, 120))